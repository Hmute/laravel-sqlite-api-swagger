...
#[
    ...
    OA\Server (url: 'http://http://laravelandswagger.azurewebsites.net/', description: "staging server"),
    OA\Server(url: 'http://http://laravelandswagger.azurewebsites.net/', description: "production server"),
